...
(Y) are called semi-supervised learning\index{Semi-supervised Learning} problems.These problems sit in between both supervised
...
feedback in terms of rewards and punishments as it navigates its problem space.\index{Reinforcement Learning}
